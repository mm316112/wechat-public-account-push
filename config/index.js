export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxaf06b6a7b39496da",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ecb46c2397c204880bab69ae006b2dbf",
  ...
  USERS: [
    {
      ...
      id: "oDJz15isMQ-AnOaFn-3wdAZJgnGQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "wmCQ2pl1AWmvlkaijoGvxRrIreceHV3glVGbBkT9thE",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "保定",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2022-3-25"},
        // 结婚纪念日
        {"keyword": "marry_day", date: "2022-0-0"},
        // 退伍日
        {"keyword": "ex_day", date: "2022-0-0"},
      ]
    },
    {
      name: "老婆1",
